...
double SCManager::distDirectSC(const Eigen::MatrixXd& _sc1, const Eigen::MatrixXd& _sc2) {
...
int SCManager::fastAlignUsingVkey(const Eigen::MatrixXd& _vkey1, const Eigen::MatrixXd& _vkey2) {
...
std::pair<double, int> SCManager::distanceBtnScanContext(const Eigen::MatrixXd& _sc1,
                                                         const Eigen::MatrixXd& _sc2) {
...
Eigen::MatrixXd SCManager::makeScancontext(const pcl::PointCloud<SCPointType>& _scan_down) {
...
Eigen::MatrixXd SCManager::makeRingkeyFromScancontext(const Eigen::MatrixXd& _desc) {
    /*
...
Eigen::MatrixXd SCManager::makeSectorkeyFromScancontext(const Eigen::MatrixXd& _desc) {
    /*
...
std::pair<int, float> SCManager::detectLoopClosureID(void) {
    int loop_id{
        -1
    }; // init with -1, -1 means no loop (== LeGO-LOAM's variable "closestHistoryFrameID")
    ...
    for(int candidate_iter_idx = 0; candidate_iter_idx < NUM_CANDIDATES_FROM_TREE;
        candidate_iter_idx++) {
        Eigen::MatrixXd polarcontext_candidate =
